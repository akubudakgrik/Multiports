...
echo " "
echo -e "\e[1;32m══════════════════Autoscript VPN-BUDAKGERIK══════════════════\e[0m" | tee -a log-install.txt
...
echo -e "\e[1;32m══════════════════Autoscript By VPN-BUDAKGERIK══════════════════\e[0m" | tee -a log-install.txt
sleep 7
clear
echo ""
echo -e "    \e[1;32m.------------------------------------------.\e[0m"
echo -e "    \e[1;32m|     SUCCESFULLY INSTALLED THE SCRIPT     |\e[0m"
echo -e "    \e[1;32m|         Premium By VPN-BUDAKGERIK68             |\e[0m"
echo -e "    \e[1;32m'------------------------------------------'\e[0m"
echo ""
