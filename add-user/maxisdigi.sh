...
patchtls=/VPNBudakGerik-vmesswstls
patchnontls=/VPNBudakGerik-vmesswsntls
...
patchtls=/VPNBudakGerik-vlesswstls
patchnontls=/VPNBudakGerik-vlesswsntls
uuid=$(cat /proc/sys/kernel/random/uuid)
read -p "   Bug Address (Example: www.google.com) : " address
read -p "   Bug SNI/Host (Example : m.facebook.com) : " sni
read -p "   Expired (days) : " masaaktif
...
patchtls=/VPNBudakGerik-trojanwstls
patchnone=/VPNBudakGerik-trojanwsntls
read -p "   Bug Address (Example: www.google.com) : " address
